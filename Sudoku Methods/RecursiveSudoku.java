...
public class RecursiveSudoku {
    ...
    private HashMap<ArrayList<Integer>, ArrayList<Integer>> buildContext(HashMap<ArrayList<Integer>, ArrayList<Integer>> context){
        //loop through puzzle
        for(int i=0;i<9;i++){
            for(int j=0;j<9;j++){
    ...
    private ArrayList<Integer> findMin(ArrayList<ArrayList<Integer>> puzzle, ArrayList<ArrayList<Integer>> boxes, HashMap<ArrayList<Integer>,ArrayList<Integer>> context){
    ...
    private void solveHelper(ArrayList<ArrayList<Integer>> puzzle, ArrayList<ArrayList<Integer>> boxes, HashMap<ArrayList<Integer>, ArrayList<Integer>> context, ArrayList<Integer> place){
            ...
            noupdate = true;
            ArrayList<Integer> location = findMin(puzzle,boxes,context);
                ...
                for(int i= 1;i<10;i++){
                    ...
                    if(rules.checkRules(row, col, i, updatedPuzzle, updatedBoxes)){
                        ...
                        if(!updatedContext.get(Arrays.asList(row,col)).contains(i)){
                           ...
                           solveHelper(updatedPuzzle, updatedBoxes, updatedContext, location);
